...
typedef Widget CustomNavBarChildBuilder(
...
/// Container for the state of a [CustomNavBar]'s animation, useful for syncing
...
/// is required.
///
/// [CustomNavBar] has two named constructors, `children` and `iconData`, and
...
///
/// [CustomNavBar] is a [StatelessWidget] that wraps an internal
...
class CustomNavBar extends StatelessWidget {
  ...
  final CustomNavBarChildBuilder? builder;
  ...
  /// HeroIcon data to render in the tab bar. Use this option if you want
  /// [CustomNavBar] to manage your tabs' colors. Pass this or [children].
  final List<HeroIcons>? iconData;
  ...
  final Color? unSelectedIconTextColor;
  ...
  CustomNavBar.builder({
    required this.builder,
    required this.numChildren,
    this.activeBadgeColors,
    this.activeIndex = 0,
    this.iconTexts,
    this.selectedIconTextColor = Constants.AppPrimaryColor,
    this.unSelectedIconTextColor = Constants.greyColor,
  ...
  CustomNavBar.iconData({
    required List<HeroIcons> this.iconData,
    this.activeBadgeColors,
    ...
    this.iconSize,
    this.iconTexts,
    this.selectedIconTextColor,
    this.unSelectedIconTextColor,
    ...
    this.sidesPerListItem,
        ...
        builder = null,
        assert(iconTexts == null || iconTexts.length == iconData.length),
        assert(indicatorSides > 2),
        assert(activeBadgeColors == null ||
            activeBadgeColors.length == 1 ||
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        return _CustomNavBarInner(
          ...
          unSelectedIconTextColor: unSelectedIconTextColor,
...
class _CustomNavBarInner extends StatefulWidget {
  final List<Color>? activeBadgeColors;
  final List<Color>? activeIconColors;
  final int activeIndex;
  final Curve animationCurve;
  ...
  _CustomNavBarInner({
    ...
    required this.selectedIconTextColor,
    required this.unSelectedIconTextColor,
  ...
  @override
  _CustomNavBarInnerState createState() => _CustomNavBarInnerState();
}

class _CustomNavBarInnerState extends State<_CustomNavBarInner>
  ...
  Color _getActiveIconColor() {
    if (widget.activeIconColors == null) {
      return widget.indicatorColors[colorIndex];
    }
  ...
  Color _getBadgeColor(int index) {
    ...
    return activeIndex == index
        ? widget.indicatorColors[colorIndex]
  ...
  Widget _buildNavBarItem(Widget child, Indexed indexed) {
    ...
    return _NavBarItem(
      ...
      textWidget: Text(widget.iconTexts![indexed.index],
          style: TextStyle(
              color: isActive
                  ? widget.selectedIconTextColor
                  : widget.unSelectedIconTextColor,
              fontSize: 13)),
  ...
  void didUpdateWidget(Widget oldWidget) {
    super.didUpdateWidget(oldWidget as _CustomNavBarInner);
